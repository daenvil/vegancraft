...
execute if score @s dnv.pickup_milk matches 1.. run function dnv.vegancraft:food/utility/update_vcount
execute if score @s dnv.dropped_milk matches 1.. run function dnv.vegancraft:food/utility/update_vcount
execute if score @s dnv.pickup_steak matches 1.. run function dnv.vegancraft:food/utility/update_vcount
execute if score @s dnv.dropped_steak matches 1.. run function dnv.vegancraft:food/utility/update_vcount