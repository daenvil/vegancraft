...
execute unless score @s dnv.success matches 0 run item modify entity @s player.cursor {"function":"set_components","components":{"custom_data":{"dnv.vegan":false},"food":{"nutrition":5,"saturation":6.0},"item_model":"dnv.vegan_food:notfish_fillet","item_name":{"fallback":"Not-fish Fillet","italic":false,"translate":"dnv.vegan_food.item.notfish_fillet"},"lore":[{"color":"red","fallback":"(Contains animal products)","italic":false,"translate":"dnv.vegancraft.contains_animal_products"},{"color":"dark_green","italic":true,"text":"Daenvil's Plant-based Foods"}]}}
