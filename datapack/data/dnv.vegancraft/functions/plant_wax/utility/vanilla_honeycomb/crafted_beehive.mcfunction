# Called by dnv.vegancraft:plant_wax/utility/player_tick_real when player crafts a beehive

scoreboard players set @s dnv.craf_beehive 0
...
# Update total counts
scoreboard players remove @s dnv.honeycombs 3