...
data modify entity @e[limit=1,sort=nearest,tag=dnv.item_checker] HandItems[0] set from entity @s Item
execute as @e[limit=1,sort=nearest,tag=dnv.item_checker] run function dnv.omni_pets:check_if_pet_food
