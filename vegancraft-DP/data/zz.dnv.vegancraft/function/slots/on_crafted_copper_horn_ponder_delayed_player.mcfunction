tag @s remove dnv.subject.crafted_copper_horn_ponder
execute store success score @s dnv.success run tag @s remove dnv.crafted_vegan
execute if score @s dnv.success matches 1 run scoreboard players set @s dnv.count.crafted_copper_horn_ponder 0
...
execute unless score @s dnv.success matches 0 run scoreboard players set @s dnv.count.crafted_copper_horn_ponder 0
execute unless score @s dnv.success matches 0 run return 0
execute store result storage dnv.vegancraft:craft_count copper_horn_ponder.count int 1 run scoreboard players get @s dnv.count.crafted_copper_horn_ponder
function zz.dnv.vegancraft:slots/on_crafted_copper_horn_ponder_replace_output with storage dnv.vegancraft:craft_count copper_horn_ponder
scoreboard players set @s dnv.count.crafted_copper_horn_ponder 0