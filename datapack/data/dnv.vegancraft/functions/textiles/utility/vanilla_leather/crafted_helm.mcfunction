# Called by dnv.vegancraft:textiles/utility/player_tick_real when player crafts leather helmet

scoreboard players set @s dnv.craf_lhelm 0
...
# Update total counts
scoreboard players remove @s dnv.leathers 5