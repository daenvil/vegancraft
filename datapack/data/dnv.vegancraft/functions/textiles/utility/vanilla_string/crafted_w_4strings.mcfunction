# Called by dnv.vegancraft:textiles/utility/player_tick_real when player uses a vanilla recipe containing 4 strings

scoreboard players set @s dnv.craf_wool 0
