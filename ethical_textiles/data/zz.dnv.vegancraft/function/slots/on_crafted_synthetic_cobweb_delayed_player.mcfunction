...
execute unless score @s dnv.success matches 0 run item modify entity @s player.cursor {"function":"set_components","components":{"custom_data":{"dnv.vegan":false},"item_name":{"fallback":"Synthetic Cobweb","italic":false,"translate":"dnv.ethical_textiles.item.synthetic_cobweb"},"lore":[{"color":"red","fallback":"(Contains animal products)","italic":false,"translate":"dnv.vegancraft.contains_animal_products"},{"color":"#954535","italic":true,"text":"Daenvil's Ethical Textiles"}]}}
