...
execute if score dnv.dummy dnv.vegancraft matches 1 if score @s dnv.just_tamed matches 1.. as @e[limit=1,sort=nearest,type=minecraft:cat,nbt={CollarColor:14b}] run data modify entity @s CollarColor set value 5
