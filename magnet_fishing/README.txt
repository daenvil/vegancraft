# Magnet Fishing (v2.2.1, for Minecraft 1.21.5+)
...
- This datapack was made by Daenvil, originally as a commission for Nora from the Vegan Minecraft Server (https://veganminecraft.com/). Its official pages are:
...
- OPTIONAL: drop the resourcepack zip file ("vegancraft-RP_v1.4.zip") inside the "resourcepacks" folder of your minecraft folder. If you don't have the resourcepack, download it from the PlanetMinecraft page above.

## Features

You can find the full list of features and more info on this page: https://daenvil.github.io/MCDatapacks/magnet_fishing.html
