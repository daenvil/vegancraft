advancement revoke @s only zz.dnv.vegancraft:triggers/harvested_cave_vines_plant
execute if score #dnv dnv.xp_from_crops_disabled matches 1 run return 0
execute unless predicate {"condition":"random_chance","chance":0.6} run return 0
